...
class BorrowRoomController extends Controller
{
    ...
    protected function detail($id)
    {
        ...
        $show->field('admin.name', ' Nama Admin');
        $show->field('admin_approval_status', 'Status Persetujuan Admin')->using(ApprovalStatus::asSelectArray());;
    ...
    protected function form()
    {
        ...
        if ($isDosen) {
            ...
            $form->radio('admin_approval_status', 'Status Persetujuan Admin')
            ...
            $form->select('admin_id', 'Nama Admin')->options(function ($id) {
